...
-- Email Queue Table (manages email sending queue)
...
-- Insert default email accounts based on .env configuration
INSERT INTO email_accounts (name, email, purpose, smtp_user, smtp_password, from_name, is_primary, priority) VALUES
('Main Business', 'info@revivatech.co.uk', 'General business communications and inquiries', 'info@revivatech.co.uk', crypt('heb0uRUCigLv', gen_salt('bf')), 'RevivaTech', true, 1),
('Customer Support', 'support@revivatech.co.uk', 'Customer service and support inquiries', 'support@revivatech.co.uk', crypt('heb0uRUCigLv', gen_salt('bf')), 'RevivaTech Support', false, 2),
('Repairs Department', 'repairs@revivatech.co.uk', 'Repair status updates and technical communications', 'repairs@revivatech.co.uk', crypt('heb0uRUCigLv', gen_salt('bf')), 'RevivaTech Repairs', false, 3),
('No Reply (Automated)', 'noreply@revivatech.co.uk', 'Automated booking confirmations and notifications', 'noreply@revivatech.co.uk', crypt('heb0uRUCigLv', gen_salt('bf')), 'RevivaTech', false, 4),
('Quotes Department', 'quotes@revivatech.co.uk', 'Price quotes and repair estimates', 'quotes@revivatech.co.uk', crypt('heb0uRUCigLv', gen_salt('bf')), 'RevivaTech Quotes', false, 5)
